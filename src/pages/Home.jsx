    ...
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            STEP UP <br /> <span className="text-transparent border-t-2 border-b-2 border-white/20 [-webkit-text-stroke:1px_white]">YOUR KICKS</span>
          </motion.h1>
      ...
      {/* --- CATEGORIES VISUELLES (AXÉES CHAUSSURES) --- */}
      ...
      <section className="container mx-auto px-6 pb-32">
        <div className="flex justify-between items-end mb-16">
          ...
          <Link to="/shop" className="text-[#00A3FF] font-bold hover:underline">Voir tout</Link>
        </div>
